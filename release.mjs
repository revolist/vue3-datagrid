...
const localDependencyName = '@revolist/vue3-datagrid';
...
function updatePackageJsonVersion(packageDir, version, dependencyName) {
...
function main() {
  ...
  updatePackageJsonVersion(fullPath, newVersion, dependencyName);
